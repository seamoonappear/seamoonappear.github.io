...
<div class="tabs-container">
  <div class="tabs-nav">
    <button class="tab-button active" data-tab="hobby">爱好</button>
    <button class="tab-button" data-tab="books">书</button>
    <button class="tab-button" data-tab="movies">电影</button>
    <button class="tab-button" data-tab="series">系列</button>
    <button class="tab-button" data-tab="games">游戏</button>
    <button class="tab-button" data-tab="others">其他</button>
  </div>
