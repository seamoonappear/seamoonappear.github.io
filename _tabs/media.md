...
<div class="media-container">
  ...
  <div class="tab-content">
    <!-- 爱好页 -->
    <div class="tab-pane" id="hobby-content">
      <h2>我的爱好</h2>
    ...
    <!-- 书页 -->
    <div class="tab-pane" id="books-content">
      <h2>我读过的书</h2>
    ...
    <!-- 电影页 -->
    <div class="tab-pane" id="movies-content">
      <h2>看过的电影</h2>
      <div class="media-item">
    ...
    <!-- 系列页 -->
    <div class="tab-pane" id="series-content">
      <h2>追过的剧集</h2>
      <div class="media-item">
    ...
    <!-- 游戏页 -->
    <div class="tab-pane" id="games-content">
      <h2>玩过的游戏</h2>
    ...
    <!-- 其他页 -->
    <div class="tab-pane" id="others-content">
      <h2>其他</h2>
      <div class="media-item">
...
#tab-series:checked ~ .tab-content #series-content,
#tab-games:checked ~ .tab-content #games-content,
#tab-others:checked ~ .tab-content #others-content {
  display: block;
}
